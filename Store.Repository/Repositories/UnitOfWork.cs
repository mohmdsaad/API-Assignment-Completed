...
namespace Store.Repository.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IGenericRepository<TEntity, TKey> Repository<TEntity, TKey>() where TEntity : BaseEntity<TKey>
        {
            ...
            // Hash Table 
            // O(1)
            // Collection Of KEY_VALUE pair
            // the Key is the name of Entity  
            // the value is instance of the model that you want
            ...
            var entityKey = typeof(TEntity).Name ; //  AS String =>    ex -> "Product"
